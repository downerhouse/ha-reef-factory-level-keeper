"""Config flow for Reef Factory Smart Level Keeper integration."""
...
DEFAULT_NAME = "Reef Factory Smart Level Keeper"


class ReeffactoryLevelKeeperConfigFlow(config_entries.ConfigFlow, domain=DOMAIN):
    """Handle a config flow for Reef Factory Smart Level Keeper."""
